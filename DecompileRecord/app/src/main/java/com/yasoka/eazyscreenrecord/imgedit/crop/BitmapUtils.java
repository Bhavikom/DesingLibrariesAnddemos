package com.yasoka.eazyscreenrecord.imgedit.crop;
...
//import com.ezscreenrecorder.imgedit.crop.CropImageView.RequestSizeOptions;
...
final class BitmapUtils {
    ...
    static com.ezscreenrecorder.imgedit.crop.BitmapUtils.RotateBitmapResult rotateBitmapByExif(Bitmap r1, Context r2, Uri r3) {
        /*
            r0 = 0
            ...
            android.support.media.ExifInterface r3 = new android.support.media.ExifInterface     // Catch:{ Exception -> 0x0014 }
        ...
        L_0x0015:
            ...
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$RotateBitmapResult r1 = rotateBitmapByExif(r1, r3)
            goto L_0x0023
        L_0x001c:
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$RotateBitmapResult r2 = new com.ezscreenrecorder.imgedit.crop.BitmapUtils$RotateBitmapResult
            r3 = 0
            r2.<init>(r1, r3)
            r1 = r2
        L_0x0023:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ezscreenrecorder.imgedit.crop.BitmapUtils.rotateBitmapByExif(android.graphics.Bitmap, android.content.Context, android.net.Uri):com.ezscreenrecorder.imgedit.crop.BitmapUtils$RotateBitmapResult");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.ezscreenrecorder.imgedit.crop.BitmapUtils.BitmapSampled cropBitmap(Context r14, Uri r15, float[] r16, int r17, int r18, int r19, boolean r20, int r21, int r22, int r23, int r24, boolean r25, boolean r26, int r27) {
        /*
            r0 = r17
            r1 = r16
            r2 = r18
        ...
        L_0x0026:
            ...
            r6 = r11
            r7 = r27
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled r2 = decodeSampledBitmapRegion(r2, r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x0037 }
        ...
        L_0x0055:
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled r0 = new com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled
            r0.<init>(r10, r8)
            return r0
        L_0x005b:
            r0 = move-exception
        ...
        L_0x0065:
            ...
            r7 = r22
            r8 = r27
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled r0 = cropBitmap(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ezscreenrecorder.imgedit.crop.BitmapUtils.cropBitmap(android.content.Context, android.net.Uri, float[], int, int, int, boolean, int, int, int, int, boolean, boolean, int):com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static Bitmap decodeImage(ContentResolver r2, Uri r3, Options r4) throws FileNotFoundException {
        /*
        L_0x0000:
            r0 = 0
        ...
        L_0x0038:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ezscreenrecorder.imgedit.crop.BitmapUtils.decodeImage(android.content.ContentResolver, android.net.Uri, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.ezscreenrecorder.imgedit.crop.BitmapUtils.BitmapSampled decodeSampledBitmapRegion(Context r4, Uri r5, Rect r6, int r7, int r8, int r9) {
        /*
            r0 = 0
        ...
        L_0x0023:
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled r8 = new com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled     // Catch:{ OutOfMemoryError -> 0x003b }
        ...
        L_0x003b:
            ...
            r7.recycle()
        L_0x004f:
            com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled r4 = new com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled
            r5 = 1
            r4.<init>(r0, r5)
            return r4
        L_0x0056:
        ...
        L_0x008f:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ezscreenrecorder.imgedit.crop.BitmapUtils.decodeSampledBitmapRegion(android.content.Context, android.net.Uri, android.graphics.Rect, int, int, int):com.ezscreenrecorder.imgedit.crop.BitmapUtils$BitmapSampled");
    }
